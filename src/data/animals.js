...
const animals = [
  ...
  },
  {
    ...
    image: img_tortoise, imageSize: { w: 1177, h: 656 }, naturalHabitat: "desert",
    ...
    anchors: {
      headTop: { x: 38, y: 26 }, eyeL: { x: 31, y: 40 }, eyeR: { x: 46, y: 40 }, nose: { x: 37, y: 54 }, mouth: { x: 37, y: 59 },
      back: { x: 52, y: 5 }, hips: { x: 76, y: 48 }, rear: { x: 90, y: 68 }, chest: { x: 48, y: 72 },
      frontFeet: [{ x: 8, y: 94 }, { x: 88, y: 90 }], hindFeet: [{ x: 4, y: 97 }, { x: 93, y: 93 }],
    },
  },
  {
  ...
  },
  {
    ...
    image: img_reindeer, imageSize: { w: 1157, h: 969 }, naturalHabitat: "arctic",
