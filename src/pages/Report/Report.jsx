    ...
    <PageTransition className="page page--bar report" style={{ "--accent": habitat.accent }}>
      <div className="report__inner">
        <header className="report__head rise">
          <div>
            <p className="eyebrow">Field entry · A new species</p>
        ...
        <section className="report__hero">
          ...
          <aside className="report__side panel rise" {...rise(0.15)}>
            <div className="report__survival">
              <div className="report__survivalhead"><span className="seclabel">Chance of surviving here</span><Badge tone="accent" icon={Info}>Estimate</Badge></div>
            ...
            <div className="report__stats">
              <p className="seclabel">Strengths and weaknesses</p>
        ...
        <section className="report__section">
          <div className="report__sechead rise" {...rise(0.2)}>
            <p className="eyebrow">What it borrowed</p>
            <h2 className="display">Three abilities, three trade-offs</h2>
          </div>
        ...
        <section className="report__section report__analysis">
          <div className="report__col panel rise" {...rise(0.3)}>
            <div className="report__colhead"><FlaskConical size={18} /><h2>What a biologist would say</h2></div>
          ...
          <div className="report__col panel rise" {...rise(0.4)}>
            <div className="report__colhead"><Scale size={18} /><h2>The costs, and the maths</h2></div>
            <p className="muted">Nothing in nature is free. Every ability this animal borrowed comes with a bill.</p>
            ...
            <div className="report__scoring">
              <p className="seclabel">How the number was worked out</p>
              <ol>
        ...
        <footer className="report__foot rise" {...rise(0.5)}>
          ...
          <div className="report__footactions">
            <Button icon={RotateCcw} onClick={runAnother}>Make another</Button>
          </div>
        </footer>
      </div>
    </PageTransition>
